...
organization_list = [
  ...
  [ "Portland Homeless Family Solutions",
    "Homelessness",
    "Giving hope to homeless families with children. Our mission is to empower homeless families with children to get back into housing - and stay there.",
    "1221 SW Yamhill St #210, Portland, OR 97205",
    "(503) 915-8306",
    "http://pdxhfs.org/"
  ],
  [ "Portland Rescue Mission",
    "Homelessness",
    "Food, shelter, clothing, mail service, restrooms, showers and other emergency services are available free of charge at Portland Rescue Mission's Burnside Shelter.",
    "111 W Burnside St, Portland, OR 97209",
    "(503) 906-7690",
    "https://www.portlandrescuemission.org/.../food-shelter-services/"
  ],
  ...
  [ "Oregon Humane Society",
    "Animal welfare",
    "Oregon Humane Society located in Portland, Oregon is a private, nonprofit animal shelter serving the needs of over 11000 pets each year.",
  ...
  [ "Animal Aid Inc.",
    "Animal welfare",
    "We are a nonprofit, no-kill animal rescue and welfare organization that has been dedicated to passionately serving animals and the people they love since 1969.",
    "5335 SW 42nd Ave, Portland, OR 97221",
    "(503) 292-6628",
    "https://animalaidpdx.org/"
  ],
  [ "My Voice Music",
    "Music and Art",
    "MVM is a nonprofit in Portland, Oregon that engages youth in music and performance to promote self-esteem, social skills, and emotional expression.",
    "538 SE Ash St, Portland, OR 97214",
    "(971) 533-8953",
    "http://myvoicemusic.org/"
  ],
  [ "Vibe of Portland",
    "Music and Art",
    "Empowering Portland's Youth through Art & Music ; Inspiring the next generation of creative leaders. Vibe believes everyone should have access to quality arts education. Through our school and studio programming, creatives have a chance to have processed based instruction, local mentors that are practicing artists and musicians themselves, and learn in a safe, inviting and positive environment.",
